...
FUNCTION_LINE_RANGES = {
    '_num':                 (1373, 1377),
    'detect_family':        (1380, 1381),
    'compute_line':         (1384, 1440),
    '_container_result':    (1443, 1459),
    'estimate_containers':  (1462, 1496),
    'compute_totals':       (1619, 1639),
    'dedup_alerts':         (1642, 1650),
    'calculate_quote':      (1751, 1837),
}
