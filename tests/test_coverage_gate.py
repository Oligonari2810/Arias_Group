...
FUNCTION_LINE_RANGES = {
    '_num':                 (2579, 2583),
    'detect_family':        (2586, 2587),
    'compute_line':         (2590, 2646),
    '_container_result':    (2649, 2665),
    'estimate_containers':  (2668, 2702),
    'compute_totals':       (2825, 2845),
    'dedup_alerts':         (2848, 2856),
    'calculate_quote':      (2957, 3043),
}
