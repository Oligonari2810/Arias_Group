...
FUNCTION_LINE_RANGES = {
    '_num':                 (2296, 2300),
    'detect_family':        (2303, 2304),
    'compute_line':         (2307, 2363),
    '_container_result':    (2366, 2382),
    'estimate_containers':  (2385, 2419),
    'compute_totals':       (2542, 2562),
    'dedup_alerts':         (2565, 2573),
    'calculate_quote':      (2674, 2760),
}
