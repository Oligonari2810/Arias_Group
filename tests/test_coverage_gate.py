...
FUNCTION_LINE_RANGES = {
    '_num':                 (1428, 1432),
    'detect_family':        (1435, 1436),
    'compute_line':         (1439, 1495),
    '_container_result':    (1498, 1514),
    'estimate_containers':  (1517, 1551),
    'compute_totals':       (1674, 1694),
    'dedup_alerts':         (1697, 1705),
    'calculate_quote':      (1806, 1892),
}
