...
FUNCTION_LINE_RANGES = {
    '_num':                 (2845, 2849),
    'detect_family':        (2852, 2853),
    'compute_line':         (2856, 2912),
    '_container_result':    (2915, 2931),
    'estimate_containers':  (2934, 2968),
    'compute_totals':       (3091, 3111),
    'dedup_alerts':         (3114, 3122),
    'calculate_quote':      (3223, 3309),
}
