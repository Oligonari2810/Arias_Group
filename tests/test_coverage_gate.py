...
FUNCTION_LINE_RANGES = {
    '_num':                 (1481, 1487),
    'detect_family':        (1488, 1491),
    'compute_line':         (1492, 1550),
    '_container_result':    (1551, 1569),
    'estimate_containers':  (1570, 1606),
    'compute_totals':       (1761, 1783),
    'dedup_alerts':         (1784, 1796),
    'calculate_quote':      (1893, 1983),
}
