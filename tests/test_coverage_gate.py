...
FUNCTION_LINE_RANGES = {
    '_num':                 (737, 741),
    'detect_family':        (744, 745),
    'compute_line':         (748, 804),
    '_container_result':    (807, 823),
    'estimate_containers':  (826, 860),
    'compute_totals':       (863, 883),
    'dedup_alerts':         (886, 897),
    'calculate_quote':      (966, 1056),
}
