...
FUNCTION_LINE_RANGES = {
    '_num':                 (2511, 2515),
    'detect_family':        (2518, 2519),
    'compute_line':         (2522, 2578),
    '_container_result':    (2581, 2597),
    'estimate_containers':  (2600, 2634),
    'compute_totals':       (2757, 2777),
    'dedup_alerts':         (2780, 2788),
    'calculate_quote':      (2889, 2975),
}
