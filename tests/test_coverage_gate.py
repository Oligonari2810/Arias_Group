...
FUNCTION_LINE_RANGES = {
    '_num':                 (2764, 2768),
    'detect_family':        (2771, 2772),
    'compute_line':         (2775, 2831),
    '_container_result':    (2834, 2850),
    'estimate_containers':  (2853, 2887),
    'compute_totals':       (3010, 3030),
    'dedup_alerts':         (3033, 3041),
    'calculate_quote':      (3142, 3228),
}
