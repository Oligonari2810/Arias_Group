...
FUNCTION_LINE_RANGES = {
    '_num':                 (2337, 2341),
    'detect_family':        (2344, 2345),
    'compute_line':         (2348, 2404),
    '_container_result':    (2407, 2423),
    'estimate_containers':  (2426, 2460),
    'compute_totals':       (2583, 2603),
    'dedup_alerts':         (2606, 2614),
    'calculate_quote':      (2715, 2801),
}
