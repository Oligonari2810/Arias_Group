...
FUNCTION_LINE_RANGES = {
    '_num':                 (2196, 2200),
    'detect_family':        (2203, 2204),
    'compute_line':         (2207, 2263),
    '_container_result':    (2266, 2282),
    'estimate_containers':  (2285, 2319),
    'compute_totals':       (2442, 2462),
    'dedup_alerts':         (2465, 2473),
    'calculate_quote':      (2574, 2660),
}
