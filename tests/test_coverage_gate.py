...
FUNCTION_LINE_RANGES = {
    '_num':                 (2864, 2868),
    'detect_family':        (2871, 2872),
    'compute_line':         (2875, 2931),
    '_container_result':    (2934, 2950),
    'estimate_containers':  (2953, 2987),
    'compute_totals':       (3110, 3130),
    'dedup_alerts':         (3133, 3141),
    'calculate_quote':      (3242, 3328),
}
