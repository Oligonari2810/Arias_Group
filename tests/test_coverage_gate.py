...
FUNCTION_LINE_RANGES = {
    '_num':                 (2661, 2665),
    'detect_family':        (2668, 2669),
    'compute_line':         (2672, 2728),
    '_container_result':    (2731, 2747),
    'estimate_containers':  (2750, 2784),
    'compute_totals':       (2907, 2927),
    'dedup_alerts':         (2930, 2938),
    'calculate_quote':      (3039, 3125),
}
