...
FUNCTION_LINE_RANGES = {
    '_num':                 (2878, 2882),
    'detect_family':        (2885, 2886),
    'compute_line':         (2889, 2945),
    '_container_result':    (2948, 2964),
    'estimate_containers':  (2967, 3001),
    'compute_totals':       (3124, 3144),
    'dedup_alerts':         (3147, 3155),
    'calculate_quote':      (3256, 3342),
}
