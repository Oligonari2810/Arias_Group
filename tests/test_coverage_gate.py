...
FUNCTION_LINE_RANGES = {
    '_num':                 (2895, 2899),
    'detect_family':        (2902, 2903),
    'compute_line':         (2906, 2962),
    '_container_result':    (2965, 2981),
    'estimate_containers':  (2984, 3018),
    'compute_totals':       (3141, 3161),
    'dedup_alerts':         (3164, 3172),
    'calculate_quote':      (3273, 3359),
}
