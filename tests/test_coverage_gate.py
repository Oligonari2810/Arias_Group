...
FUNCTION_LINE_RANGES = {
    '_num':                 (1548, 1552),
    'detect_family':        (1555, 1556),
    'compute_line':         (1559, 1615),
    '_container_result':    (1618, 1634),
    'estimate_containers':  (1637, 1671),
    'compute_totals':       (1794, 1814),
    'dedup_alerts':         (1817, 1825),
    'calculate_quote':      (1926, 2012),
}
