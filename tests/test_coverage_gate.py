...
FUNCTION_LINE_RANGES = {
    '_num':                 (1481, 1485),
    'detect_family':        (1488, 1489),
    'compute_line':         (1492, 1548),
    '_container_result':    (1551, 1567),
    'estimate_containers':  (1570, 1604),
    'compute_totals':       (1727, 1747),
    'dedup_alerts':         (1750, 1758),
    'calculate_quote':      (1859, 1945),
}
