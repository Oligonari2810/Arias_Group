...
FUNCTION_LINE_RANGES = {
    '_num':                 (2421, 2425),
    'detect_family':        (2428, 2429),
    'compute_line':         (2432, 2488),
    '_container_result':    (2491, 2507),
    'estimate_containers':  (2510, 2544),
    'compute_totals':       (2667, 2687),
    'dedup_alerts':         (2690, 2698),
    'calculate_quote':      (2799, 2885),
}
